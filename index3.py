...
initial_game_start = False  # Track the initial game start
    ...
    if not game_started:
        ...
        pygame.display.update() 
            ...
            if game_over==True:
                ...
                text_render1 = font.render(game_over_text, True, (255, 255,0))
                text_rect1 = text_render1.get_rect(center=(650, 300))
                screen.blit(text_render1, text_rect1.center)
                # Display "Restart" button
                restart_prompt_font = pygame.font.Font(None, 48)
                game_over_text = "Press Enter to Restart"
                text_render2 = font.render(game_over_text, True, (0, 255,0))
                text_rect2 = text_render1.get_rect(center=(550, 500))
                screen.blit(text_render2, text_rect2.center)
